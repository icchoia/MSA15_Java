...
public class Ex18_DoWhile {
	public static void main(String[] args) {
		...
		do {
			...
			System.out.println("2. 김빱");
			System.out.println("3. 새우버그");
			...
			switch (menuNo) {
				...
				case 2: menuName = "김빱"; break;
				case 3: menuName = "새우버그"; break;
			...
			if ( menuNo >= 0 && menuNo <= 5 ) {
				...
				System.err.println("(0~5)번 사이를 입력해주세요 !");
			}

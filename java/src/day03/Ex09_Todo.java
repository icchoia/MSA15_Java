...
/* 할일 목록 프로그램
 * 최대 10개의 할일을 관리할 수 있ㄴ느 프로그램
 * 메뉼르 통해 할일을 추가, 조회, 상태변경 할 수 있는 기능 구현
 * 기능 :  1.할일 추가 , 2. 할일 목록,  3.상태 변경
 * 
...
enum Status {
	...
	private final String status;	// 상수선언 - 상태의 값을 저장하는 상수 
...
class Todo {
	...
	// alt + shift + S : 소스메뉴 -- 생성자, getter/setter, toString
		...
		while ( true ) {
			...
			switch ( menuNo ) {
				...
				case 3:	// 상태변경
					...
					int index = sc.nextInt() - 1;	// 배열은 0부터 시작함
					sc.nextLine();					// 남은 엔터 제거
